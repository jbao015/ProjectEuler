...
Many ways to solve this problem. One such way with O(nlog(n)) time complexity is using the sieve of Erasthotenes.

The base approach is pretty wasteful memory-wise, but there are many ways to refine the approach
